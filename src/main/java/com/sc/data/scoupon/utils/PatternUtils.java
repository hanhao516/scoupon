...
//    	method1();
    	String url = "https://a.m.taobao.com/i569076468661.htm?price=29.99-111&original_price=119&sourceType=item&sourceType=item&suid=5b3d4c5a-e7e0-47b3-ae07-6e1748e65128&ut_sk=1.VO%2BCVaqjuVsDABUNTTnxbLxl_21646297_1539960055154.Copy.1&un=87427f05a25903949eedd86203cf18d8&share_crt_v=1&sp_tk=77+ldGZrQ2I2TUVpN3jvv6U=&spm=a211b4.23496927&visa=13a09278fde22a2e&disablePopup=true&disableSJ=1";
//    	String rex = "i\\d+";
    	String rex = "price=[\\d+\\.]*";
    	System.out.println(new PatternUtils().rexString(rex, url).split("=")[1]);
    }  
    public String  rexString(String rex,String str) {
    ...
    public List<String>  rexStrings(String rex,String str) {
    	Matcher m = Pattern.compile(rex).matcher(str);
